...
import {
  ...
  promoDiscount,
} from "../Futurecher/Slice/shippingPriceSlice";
...
>>>>>>> 9e080e4f0e88e48ea1ed5c2ec24c25c8a6de7c7e
  ...
  px-2 py-2   bg-slate-100 border rounded-md   outline-none  focus:border-blue-400 mt-2 dark:focus:border-blue-300 focus:ring-blue-300 focus:ring focus:ring-opacity-40"
        ...
        <div className="mt-5">
          ...
          />
          {discount ? (
            <label className="px-1 text-sm text-red-500" htmlFor="">
          ...
          <div>
            <button
              ...
              className={
                discount
                  ? "px-8 mt-3 py-2 bg-red-200 rounded-lg text-white"
                  : "px-8 mt-3 py-2 bg-[#062C30] rounded-lg text-white"
              }
            >
              APPLY
            </button>
