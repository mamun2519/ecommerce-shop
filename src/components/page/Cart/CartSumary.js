 ...
 const selectDelivaryHendeler = (e)=>{
  ...
  px-2 py-2   bg-slate-100 border rounded-md   outline-none  focus:border-blue-400 mt-2 dark:focus:border-blue-300 focus:ring-blue-300 focus:ring focus:ring-opacity-40"
        ...
        <div className="mt-5">
         ...
         <div>
         <button  disabled={discount} onClick={()=>applayPromoCodeHendeler()} className={discount? "px-8 mt-3 py-2 bg-red-400 rounded-lg text-white": "px-8 mt-3 py-2 bg-red-500 rounded-lg text-white"}>
            APPLY
          </button>
         </div>
        </div>
