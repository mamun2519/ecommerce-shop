...
=======
    fetch(`http://207.244.230.118:5000/user/single/${userId}`)
        ...
        <div className="w-full lg:w-9/12 mx-auto border  shadow-md rounded-lg p-5">
          ...
          <div className="h-8 relative">
            <div class="avatar online">
              <div class="w-28 rounded-full absolute top-[-110px] lg:top-[-110px] left-10">
                <img className="" src={myProfile?.avatar?.url} />
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center mt-3">
            <NavLink
              ...
              className="bg-[#062C30] text-white px-6 py-1  rounded-lg"
            >
              Edit Profile
            </NavLink>
          </div>
          <div className="mt-5 flex justify-center">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="">
                  Studied At{" "}
                  <span className=" font-medium">{myProfile?.univercity}</span>
                </span>
              </div>
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="">
                  Profession At{" "}
                  <span className=" font-medium">{myProfile?.profession}</span>
                </span>
              </div>
              <div className="flex items-center gap-2 mt-2">
                <span className=" text-xl">
                ...
                <span className="">
                  Job Title At{" "}
                  <span className=" font-medium">{myProfile?.jobtitle}</span>
                </span>
              </div>
              <div className="flex items-center gap-2 mt-2">
                <span className=" text-xl">
                ...
                <span className="">
                  Date Of Biths At{" "}
                  <span className=" font-medium">{myProfile?.birthday}</span>
                </span>
              </div>
              <div className="flex items-center gap-2 mt-2">
                <span className=" text-xl">
              ...
              <div className="flex items-center gap-2 mt-2">
                ...
                <span className="">
                  Joining Date At{" "}
                  <span className=" font-medium">{myProfile?.createdAt}</span>
                </span>
              </div>
            </div>
          </div>
